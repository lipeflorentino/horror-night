...
/// <summary>
/// Parser para carregar BattlerStates do CSV e gerar BattlerStateSO
/// </summary>
public static class BattlerStateCsvParser
{
    public static List<BattlerStateSO> Parse(string csvText)
    {
        List<BattlerStateSO> states = new();
        ...
        for (int i = 1; i < rows.Count; i++)
        {
            ...
            BattlerStateSO state = ScriptableObject.CreateInstance<BattlerStateSO>();
            ...
            {
                sprite = AssetDatabase.LoadAssetAtPath<Sprite>("Assets/Art/Sprites/BattlerStates/" + iconName + ".png");
            }
#endif
            
            state.Id = id;
            state.DisplayName = Get(row, columns, "DisplayName");
            state.Description = Get(row, columns, "Description");
            state.Icon = sprite;
