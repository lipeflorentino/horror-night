...
public class AttackEffectFeedbacks : MonoBehaviour
{
    ...
    public void ShowAttackEffect(bool attackerIsPlayer)
    {
        ...
        if (anchor == null || attackEffectPrefab == null)
        {
            Debug.LogError("[AttackEffectFeedbacks] Attack effect anchor or prefab reference is missing.");
            return;
        }
