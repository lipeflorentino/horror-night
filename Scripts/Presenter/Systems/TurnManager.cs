...
public class TurnManager
{
    ...
    private IEnumerator ExecutePlayerAttackTurn(CombatSceneBindings bindings)
    {
        ...
        bindings.NotifyPlayerAction($"Ação: {playerTurnActions.Format(playerAttack)}");
        bindings.NotifyEnemyAction($"Reação: {enemyTurnActions.Format(enemyDefense)}");
    ...
    private IEnumerator ExecuteEnemyAttackTurn(CombatSceneBindings bindings)
    {
        ...
        bindings.NotifyEnemyAction($"Ação: {enemyTurnActions.Format(enemyAttack)}");
        ...
        bindings.NotifyPlayerAction($"Reação: {playerTurnActions.Format(playerDefense)}");
